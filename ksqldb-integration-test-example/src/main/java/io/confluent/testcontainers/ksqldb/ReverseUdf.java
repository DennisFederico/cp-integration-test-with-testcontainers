...
public class ReverseUdf {
    ...
    public String reverseString(
            @UdfParameter(value = "source", description = "the value to reverse") final String source
    ) {
    ...
    public String reverseInt(
            @UdfParameter(value = "source", description = "the value to reverse") final Integer source
    ) {
    ...
    public String reverseLong(
            @UdfParameter(value = "source", description = "the value to reverse") final Long source
    ) {
        return new StringBuilder(source.toString()).reverse().toString();
    }
    ...
    public String reverseDouble(
            @UdfParameter(value = "source", description = "the value to reverse") final Double source
    ) {
        return new StringBuilder(source.toString()).reverse().toString();
    }
}
